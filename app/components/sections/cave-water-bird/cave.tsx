        ...
        <div className="h-full w-full flex flex-col fixed top-0 left-0 gap-0 px-20 pt-[90px] pb-10 z-40">
          ...
          {showText1 && (
            <motion.div
              ...
              <p className="text-[clamp(14px,1.05vw,18px)] leading-[1.4] col-span-2 w-5/6 2xl:w-2/3 text-clamp h-fit text-white text-justify font-bold ">
                Исследования доказали её уникальный оздоровительный эффект, включая омоложение и продление
                 жизни.
              </p>
              <p className="text-[clamp(14px,1.05vw,18px)] leading-[1.4] col-span-2 w-5/6 2xl:w-2/3 text-clamp h-fit text-white text-justify font-bold ">
                Венгерский ученый Габор Шомлай подтвердил: легкая вода способна замедлить 
                ...
                приближена к межклеточной жидкости нашего организма.
              </p>    </div>
            </motion.div>
          )}
...
<div></div>
                <p className="text-[clamp(14px,1.05vw,18px)] leading-[1.4] col-span-2 w-5/6 2xl:w-2/3 text-clamp h-fit text-white text-justify font-bold ">
                  Легкая вода — это не лекарство, а природная поддержка организма. Она работает мягко, 
