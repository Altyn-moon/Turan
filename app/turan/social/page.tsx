  ...
  return (
    ...
    <main ref={ref} className="font-rubik">
      ...
      <section className="social-block">
        ...
        <span className="blue-dot"></span> доставка и логистика оптимизируются, чтобы снизить нагрузку на окружающую среду.<br></br>
        Каждая стадия цикла — от источника до полки — подчинена идее сохранения экологического равновесия.</p>
      </section>

      {/* Water Section */}
      <section className="social-block">
        <p>TURAN видит свою задачу шире, чем просто производство воды. Это просветительская миссия: формировать культуру потребления, где выбор в пользу экологичного продукта становится нормой. <br></br>
